...
var GenerateCPF = /*#__PURE__*/function () {
  ...
  _createClass(GenerateCPF, [{
    ...
    key: "genCPF",
    value: function genCPF() {
      var first9Digits = this.rand();
      var digit1 = _ValidateCPF__WEBPACK_IMPORTED_MODULE_0__["default"].createDigit(first9Digits);
      var digit2 = _ValidateCPF__WEBPACK_IMPORTED_MODULE_0__["default"].createDigit(first9Digits + digit1);
...
var ValidateCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidateCPF, [{
    ...
    value: function validate() {
      ...
      var parcialCPF = this.cpf.slice(0, -2);
      var digit1 = ValidateCPF.createDigit(parcialCPF);
      var digit2 = ValidateCPF.createDigit(parcialCPF + digit1);
      var newCPF = parcialCPF + digit1 + digit2;
    ...
    key: "createDigit",
    value: function createDigit(parcialCPF) {
      var cpfArray = Array.from(parcialCPF);
      var regressive = cpfArray.length + 1;
      var total = cpfArray.reduce(function (acc, el) {
