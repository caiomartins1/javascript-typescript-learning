...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ":root {\n  --primary-color: rgb(13, 106, 134);\n  --primary-color-dark: rgb(8, 64, 82);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  font-family: 'Open-sans', sans-serif;\n  border-radius: 10px;\n}\n\nform input,\nform label,\nform button {\n  display: block;\n  width: 100%;\n  margin-bottom: 20px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\nform input:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nform button {\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700;\n  height: 50px;\n  margin-top: 40px;\n  margin-bottom: 0;\n  cursor: pointer;\n  transition: background 0.2s;\n}\n\nform button:hover {\n  background: var(--primary-color-dark);\n}\n\n.result {\n  font-size: 2em;\n  color: var(--primary-color);\n  margin: 40px 0;\n}\n\ninput[type='checkbox'] {\n  width: 15px;\n  height: 15px;\n}\n\nbutton {\n  margin: 20px 0;\n  display: block;\n  font-size: 1.2em;\n}\n", "",{"version":3,"sources":["webpack://src/assets/css/style.css"],"names":[],"mappings":"AAEA;EACE,kCAAkC;EAClC,oCAAoC;AACtC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,oCAAoC;EACpC,mBAAmB;AACrB;;AAEA;;;EAGE,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,eAAe;AACjB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,YAAY;EACZ,gCAAgC;EAChC,WAAW;EACX,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,gBAAgB;EAChB,gBAAgB;EAChB,eAAe;EACf,2BAA2B;AAC7B;;AAEA;EACE,qCAAqC;AACvC;;AAEA;EACE,cAAc;EACd,2BAA2B;EAC3B,cAAc;AAChB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,cAAc;EACd,cAAc;EACd,gBAAgB;AAClB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap');\n\n:root {\n  --primary-color: rgb(13, 106, 134);\n  --primary-color-dark: rgb(8, 64, 82);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  font-family: 'Open-sans', sans-serif;\n  border-radius: 10px;\n}\n\nform input,\nform label,\nform button {\n  display: block;\n  width: 100%;\n  margin-bottom: 20px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\nform input:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nform button {\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700;\n  height: 50px;\n  margin-top: 40px;\n  margin-bottom: 0;\n  cursor: pointer;\n  transition: background 0.2s;\n}\n\nform button:hover {\n  background: var(--primary-color-dark);\n}\n\n.result {\n  font-size: 2em;\n  color: var(--primary-color);\n  margin: 40px 0;\n}\n\ninput[type='checkbox'] {\n  width: 15px;\n  height: 15px;\n}\n\nbutton {\n  margin: 20px 0;\n  display: block;\n  font-size: 1.2em;\n}\n"],"sourceRoot":""}]);
// Exports
...
(function () {
  ...
  button.addEventListener('click', function (event) {
    var generator = new _modules_PasswordGenerator__WEBPACK_IMPORTED_MODULE_0__["default"]();
    div.innerHTML = "".concat(generator.genPassword());
  });
})();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PasswordGenerator; });
...
var PasswordGenerator = /*#__PURE__*/function () {
  function PasswordGenerator() {
    ...
    this.generator = new _Generator__WEBPACK_IMPORTED_MODULE_0__["default"]();
  ...
  _createClass(PasswordGenerator, [{
    ...
    value: function genPassword() {
      ...
      return password.join('').slice(0, this.passwordLength) || 'Nothing Selected';
    }
  }]);
